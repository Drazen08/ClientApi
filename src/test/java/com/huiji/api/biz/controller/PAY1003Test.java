 ...
 */
public class PAY1003Test {

    @Test
    public void testV() throws Exception {
        String body = "eJyr5lIAAqX8opTUIs8UJSsFJUMzAwtDAwNLYyMDAwNDJR2IgqTEnMS85FSQAmMDEFDiqgUAojsNeA==";
        ...
        String req = "{    \"deviceId\": \"设备编号\",\n" +
                ...
                "    \"digest\": \"" + digest + "\"\n" +
                "}";
        HttpRequest http_req = HttpRequest.post("http://localhost:8080/android/1.0/PAY1003/1.0");
