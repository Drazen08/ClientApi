 ...
 */
public class PAY1002Test {

    @Test
    public void testV() throws Exception {
        String body = "eJyr5lIAAqX8opTUIs+UYiWraCVDMwMLQwMDS2MjAwMDQ6VYHYiSpMScxLzkVCUrJVMDAyWuWgCfoA3V";
        ...
        String req = "{    \"deviceId\": \"设备编号\",\n" +
                ...
                "    \"digest\": \"" + digest + "\"\n" +
                "}";
        HttpRequest http_req = HttpRequest.post("http://localhost:8080/android/1.0/PAY1002/1.0");
