 ...
 */
public class SHO1002Test {
    @Test
    public void testV() throws Exception {
        String body = "eJyr5lIqzsgvyExRslIyVNLhUlBQKqksSEXwChLTU/Pyy8ECXLUAJwkMDA==";
        ...
        String req = "{    \"deviceId\": \"设备编号\",\n" +
                ...
                "    \"digest\": \"" + digest + "\"\n" +
                "}";
        HttpRequest http_req = HttpRequest.post("http://localhost:8080/android/1.0/SHO1002/1.0");
