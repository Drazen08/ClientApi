 ...
 */
public class SHO1001Test {
    @Test
    public void testV() throws Exception {
        String body = "eJyr5lIqzsgvyExRslIyVOKqBQApjgSH";
        ...
        String req = "{    \"deviceId\": \"设备编号\",\n" +
                ...
                "    \"digest\": \"" + digest + "\"\n" +
                "}";
        HttpRequest http_req = HttpRequest.post("http://localhost:8080/clientApi/android/1.0/all/SHO1001/1.0");
