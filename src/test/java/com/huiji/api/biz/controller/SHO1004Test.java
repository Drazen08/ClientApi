 ...
 */
public class SHO1004Test {
    @Test
    public void testV() throws Exception {
        String body = "eJxTqOZSAAKlksqCVCUrJUMlHQi/OCO/wDMFLAIUqAUAq/0Isg==";
        ...
        String req = "{    \"deviceId\": \"设备编号\",\n" +
                ...
                "    \"digest\": \"" + digest + "\"\n" +
                "}";
        HttpRequest http_req = HttpRequest.post("http://localhost:8080/clientApi/android/1.0/all/SHO1004/1.0");
