 ...
 */
public class SHO1000Test {
    @Test
    public void testV() throws Exception {
        String body = "eJyr5uJUSs4sqfRMUbJSUDJU4uLkqgUANc4Eog==";
        ...
        String req = "{    \"deviceId\": \"设备编号\",\n" +
                ...
                "    \"digest\": \"" + digest + "\"\n" +
                "}";
        HttpRequest http_req = HttpRequest.post("http://localhost:8080/clientApi/android/1.0/all/SHO1000/1.0");
