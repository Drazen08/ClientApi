 ...
 */
public class MAR1000Test {
    @Test
    public void testV() throws Exception {
        String body = "eJyr5lIAAqXkzJJKzxQlKwUlQyUdiFBBYnpqXn45RIyrFgDJcQnA";
        ...
        String req = "{    \"deviceId\": \"设备编号\",\n" +
                ...
                "    \"digest\": \"" + digest + "\"\n" +
                "}";
        HttpRequest http_req = HttpRequest.post("http://192.168.0.200:8080/clientApi/android/1.0/all/MAR1000/1.0");
