 ...
 */
public class DIC1003Test {

    @Test
    public void testV() throws Exception {
        String body = "eJyr5lIAAqW8xDLPFCUrBSVDJR2ISEllQSqKQEFiempefjlEjKsWAGntDNc=";
        ...
        String req = "{    \"deviceId\": \"设备编号\",\n" +
                ...
                "    \"digest\": \"" + digest + "\"\n" +
                "}";
        HttpRequest http_req = HttpRequest.post("http://localhost:8080/android/1.0/DIC1003/1.0");
