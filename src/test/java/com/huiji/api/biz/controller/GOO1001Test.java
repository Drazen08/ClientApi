 ...
 */
public class GOO1001Test {
    @Test
    public void testV() throws Exception {
        String body = "eJyr5lIAAqX0/PyUzBQlKwUlQyUdiFBJZUEqSMAEJlCQmJ6al18OUcRVCwCFQg1e";
        ...
        String req = "{    \"deviceId\": \"设备编号\",\n" +
                ...
                "    \"digest\": \"" + digest + "\"\n" +
                "}";
        HttpRequest http_req = HttpRequest.post("http://localhost:8080/api/android/1.0/all/GOO1001/1.0");
