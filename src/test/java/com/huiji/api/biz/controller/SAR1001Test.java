 ...
 */
public class SAR1001Test {

    @Test
    public void testV() throws Exception {
        String body = "eJyr5lIAAqXk/LyS1LwSJSsFJSUdiFBJZUEqiG8ME0guLSoCqglITAeLGypx1QIA1cwPQA==";
        ...
        String req = "{    \"deviceId\": \"设备编号\",\n" +
                ...
                "    \"digest\": \"" + digest + "\"\n" +
                "}";
        HttpRequest http_req = HttpRequest.post("http://localhost:8080/android/1.0/SAR1001/1.0");
