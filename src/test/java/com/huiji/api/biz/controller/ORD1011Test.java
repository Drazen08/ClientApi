 ...
 */
public class ORD1011Test {

    @Test
    public void testV() throws Exception {
        String body = "eJyr5lIAAqX8opTUoswUJSsFJUMzAwtDC0NzI2MDAwNDJa5aAJkyCB4=";
        //eJyr5lIAAqX8opTUoswUJSsFJUMzAwtDC0NzI2MDAwMjJa5aAJk2CB8=
        ...
        String req = "{    \"deviceId\": \"设备编号\",\n" +
                ...
                "    \"digest\": \"" + digest + "\"\n" +
                "}";
        HttpRequest http_req = HttpRequest.post("http://localhost:8080/clientApi/android/1.0/all/ORD1011/1.0");
