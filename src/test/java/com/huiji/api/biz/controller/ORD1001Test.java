 ...
 */
public class ORD1001Test {

    @Test
    public void testV() throws Exception {
        String body = "eJyr5lIAAqX8opTUIs8UJSslQzMDC0MLQ3MjYwMDA0MlHYh8QWJlQGJxcTlQHUiNoaESVy0Ap4MOhg==";
        ...
        String req = "{    \"deviceId\": \"设备编号\",\n" +
                ...
                "    \"digest\": \"" + digest + "\"\n" +
                "}";
        HttpRequest http_req = HttpRequest.post("http://localhost:8080/clientApi/android/1.0/all/ORD1001/1.0");
